...
const PlayerEditForm: React.FC<PlayerEditFormProps> = ({ player, onFinished }) => {
...
const PlayerEditFormView: React.FC<PlayerEditFormViewProps> = ({ form, editPlayer, isLoading }) => {
