...
type MatchCreateFormViewProps = {
  ...
  ) => Promise<EventsRouterOutput["createMatch"]>;
  isLoading: boolean;
};

const MatchCreateFormView: React.FC<MatchCreateFormViewProps> = ({
  form,
  createMatch,
  isLoading,
}) => {
      ...
      <div className="flex flex-col items-center justify-center gap-4">
        <div>
          <Controller
            ...
            control={control}
            render={({ field }) => (
              <PlayerSelect {...field} placeholder="First player" required />
            )}
          />
        </div>
        <div>
      ...
      <div className="flex flex-col items-center justify-center gap-4">
        <div>
          <Controller
            ...
            control={control}
            render={({ field }) => (
              <PlayerSelect {...field} placeholder="Second player" required />
            )}
          />
        </div>
        <div>
