...
import type { EventsRouterOutput, EventsRouterInput } from '../server/trpc/router/events';
...
const EventCreateFormView: React.FC<EventCreateFormViewProps> = ({ isLoading, form, createNewEvent }) => {
