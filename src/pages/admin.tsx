...
const PlayersListRow: React.FC<PlayersListRowProps> = ({ player }) => {
    ...
    const mutation = trpc.naseliga.removePlayer.useMutation({
        onSuccess: () => {
    ...
    return (
        <tr>
            ...
            <td className="border-b">
                ...
                <button className="bg-red-700 rounded-md text-white text-center flex m-1 items-center p-2" onClick={removePlayer}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1">
