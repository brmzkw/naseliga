    ...
    return (
        <form onSubmit={handleSubmit(editPlayer)} className="flex gap-3 items-center pb-2 border-b">
            ...
            <div className="flex gap-1">
                {edit &&
                    <button type="submit" className="bg-green-700 rounded-md text-white text-center flex items-center p-1 pr-2">
                ...
                {edit ||
                    <>
                        <button type="button" className="bg-slate-700 rounded-md text-white text-center flex items-center p-1 pr-2" onClick={() => setEdit(true)}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                            </svg>
                            <div>Edit</div>
                        </button>
                        <button type="button" className="bg-red-700 rounded-md text-white text-center flex items-center p-1 pr-2" onClick={removePlayer}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1">
